...
function CourseListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CourseInterface[]>(
    ...
    () =>
      getCourses({
        relations: ['user', 'course_category.count', 'material.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('material', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>material</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
