...
import { getCourseCategoryById } from 'apiSdk/course-categories';
...
function CourseCategoryViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('course_category', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/course-categories/edit/${data?.id}`} passHref legacyBehavior>
              <Button
