...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'instructor', 'administrator', 'content-creator'];
  ...
  const { data, error, isLoading } = useSWR<SchoolInterface[]>(
    ...
    () => getSchools({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Category', path: '/categories', entity: 'category', service: AccessServiceEnum.PROJECT, icon: FiTag },
    { name: 'Course', path: '/courses', entity: 'course', service: AccessServiceEnum.PROJECT, icon: FiBook },
    {
    ...
    { name: 'Material', path: '/materials', entity: 'material', service: AccessServiceEnum.PROJECT, icon: FiFileText },
